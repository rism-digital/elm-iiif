...
Elm helpers, types, and decoders for working with IIIF [Presentation](https://iiif.io/api/presentation/3.0/) and [Image](https://iiif.io/api/image/3.0/) APIs.
...
Minimal example that requests a manifest, decodes it, and shows the label and summary:
